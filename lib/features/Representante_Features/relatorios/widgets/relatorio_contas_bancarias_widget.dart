...
/// Widget do relatório de Contas Bancárias.
/// Campos: Mês/Ano, Filtro (Intervalo, Conta Bancária dropdown),
/// Checkboxes (Saldo Inicial/Final, Saldo por Conta, Detalhado),
/// Ver PDF/Visualizar/E-mail/Share
class RelatorioContasBancariasWidget extends StatefulWidget {
  const RelatorioContasBancariasWidget({super.key});

  @override
  State<RelatorioContasBancariasWidget> createState() =>
      _RelatorioContasBancariasWidgetState();
}

class _RelatorioContasBancariasWidgetState
    extends State<RelatorioContasBancariasWidget> {
  ...
  String _contaBancaria = 'Santander';
  bool _saldoInicialFinal = false;
  bool _saldoPorConta = false;
          ...
          Wrap(
            ...
            children: [
              _checkboxTile(
                'Saldo Inicial/Final',
                _saldoInicialFinal,
                (v) => setState(() => _saldoInicialFinal = v),
              ),
              _checkboxTile(
                'Saldo por Conta',
                _saldoPorConta,
                (v) => setState(() => _saldoPorConta = v),
              ),
              _checkboxTile(
                'Detalhado',
                _detalhado,
            ...
            children: [
              ...
              Expanded(
                child: DropdownButtonFormField<String>(
                  ...
                  items: ['Santander', 'Banco Inter', 'Bradesco', 'Itaú']
                      .map(
                        (e) => DropdownMenuItem(
                          value: e,
                      ...
                      .toList(),
                  onChanged: (v) {
                    if (v != null) setState(() => _contaBancaria = v);
                  },
                ),
              ),
            ],
