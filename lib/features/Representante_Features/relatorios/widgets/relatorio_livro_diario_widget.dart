...
/// Widget do relatório Livro Diário de Lançamento.
/// Campos: Mês/Ano, Filtro (Intervalo, Conta Contábil dropdown),
/// Checkboxes (Saldo Inicial/Final, Saldo por Conta, Detalhado),
/// Ver PDF/Visualizar/E-mail/Share
class RelatorioLivroDiarioWidget extends StatefulWidget {
  const RelatorioLivroDiarioWidget({super.key});

  @override
  State<RelatorioLivroDiarioWidget> createState() =>
      _RelatorioLivroDiarioWidgetState();
}

class _RelatorioLivroDiarioWidgetState
    extends State<RelatorioLivroDiarioWidget> {
            ...
            children: [
              ...
              Expanded(
                child: DropdownButtonFormField<String>(
                  value: _contaContabil.isEmpty ? null : _contaContabil,
                  isDense: true,
                  ...
                  items:
                      [
                          ...
                          .toList(),
                  onChanged: (v) {
                    if (v != null) setState(() => _contaContabil = v);
                  },
                ),
              ),
            ],
