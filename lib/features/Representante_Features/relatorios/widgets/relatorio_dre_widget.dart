...
/// Widget do relatório DRE.
/// Campos: Mês/Ano, Filtro (Intervalo), Checkboxes (Saldo Inicial/Final,
/// Saldo por Conta, Detalhado), Ver PDF/Visualizar/E-mail/Share
class RelatorioDreWidget extends StatefulWidget {
  const RelatorioDreWidget({super.key});

  @override
  State<RelatorioDreWidget> createState() => _RelatorioDreWidgetState();
}

class _RelatorioDreWidgetState extends State<RelatorioDreWidget> {
