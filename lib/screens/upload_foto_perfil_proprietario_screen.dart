...
class UploadFotoPerfilProprietarioScreen extends StatefulWidget {
  ...
  const UploadFotoPerfilProprietarioScreen({
    super.key,
    required this.proprietario,
  });

  @override
  State<UploadFotoPerfilProprietarioScreen> createState() =>
      _UploadFotoPerfilProprietarioScreenState();
}
...
class _UploadFotoPerfilProprietarioScreenState
  ...
  void _skipUpload() {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(
        builder: (context) =>
            ProprietarioDashboardScreen(proprietario: widget.proprietario),
      ),
    );
  }
