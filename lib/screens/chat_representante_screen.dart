...
class ChatRepresentanteScreen extends StatefulWidget {
  final String nomeContato;
  final String apartamento;

  const ChatRepresentanteScreen({
    super.key,
  ...
  @override
  State<ChatRepresentanteScreen> createState() => _ChatRepresentanteScreenState();
}

class _ChatRepresentanteScreenState extends State<ChatRepresentanteScreen> {
    ...
    final mockMessages = [
      {
        ...
        'remetente': widget.nomeContato,
        'apartamento': widget.apartamento,
      },
      {
        'texto': 'OK ${widget.nomeContato.split(' ')[0]}, irei avisar sim.',
        'isMe': true,
